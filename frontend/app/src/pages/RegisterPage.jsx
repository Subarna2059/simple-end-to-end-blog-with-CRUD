            ...
            <div className='w-[100vw] h-[100vh]  flex justify-center items-center'>
                <div className=' w-[20VW] flex items-center h-[60vh]  rounded-3xl shadow-lg'>
                    <form className="max-w-md mx-auto">
                        ...
                        <button onClick={(e)=>{handleOnClick(e)}} type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
                    </form>
                </div>
            </div>
        </>
